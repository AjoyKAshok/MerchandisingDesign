...
class MerchandiserJourneyPlan extends StatefulWidget {
  static const routeName = '/JourneyPlan';
  MerchandiserJourneyPlan({Key? key}) : super(key: key);

  @override
  State<MerchandiserJourneyPlan> createState() =>
      _MerchandiserJourneyPlanState();
}

class _MerchandiserJourneyPlanState extends State<MerchandiserJourneyPlan> {
